...
public class BaoxiuEntity<T> implements Serializable {
	 ...
	 * 设置：报修描述
	 */
	public void setBaoxiumiaoshu(String baoxiumiaoshu) {
		this.baoxiumiaoshu = baoxiumiaoshu;
	}
	/**
	 * 获取：报修描述
	 */
	public String getBaoxiumiaoshu() {
		return baoxiumiaoshu;
	}
	/**
	 * 设置：报修状态
	 */
